...
namespace AspNetCoreWebAPI8.Controllers
{
    ...
    public class MoviesController : ControllerBase
    {
        ...
        // Get : api/Movies  bütün verileri getirir
        [HttpGet]
        ...
        // Get : api/Movies/2 olarak girildiğinde id değerine sahip movies verisini getirir
        [HttpGet("{id}")]
        ...
        // Post : api/Movies bu post atribütü movie veri kaydetme işlemini yapar
        [HttpPost]
        ...
        // Put : api/Movies/2 id değerine göre güncelleme işlemini yapar 
        [HttpPut]
        ...
        // Delete : api/Movies/2 id değrine göre silme işlemini yapar 
        [HttpDelete("{id}")]
